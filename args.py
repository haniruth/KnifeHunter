...
def argument_parser():
    ...
    parser.add_argument('--val_datacsv', type=str, default='dataset/validation.csv', help='Load validation data from csv file')
    ...
    parser.add_argument('--n_classes', type=int, default=543, help='Number of classes in the dataset')
    parser.add_argument('--num_workers', type=int, default=8, help='Number of workers for dataloader')
    parser.add_argument('--seed', type=int, default=None, help='Random seed')
    parser.add_argument('--resized_img_weight', type=int, default=224, help='Resized image width')
    parser.add_argument('--resized_img_height', type=int, default=224, help='Resized image height')
    ...
    parser.add_argument('--random-resized-crop', action='store_true', help='Use random resized crop during training')
    parser.add_argument('--crop-scale-min', type=float, default=0.75, help='Minimum scale for random resized crop')
    parser.add_argument('--crop-ratio-min', type=float, default=0.75, help='Minimum aspect ratio for random resized crop')
    parser.add_argument('--crop-ratio-max', type=float, default=1.33, help='Maximum aspect ratio for random resized crop')
    parser.add_argument(
        "--random-erase",
        action="store_true",
